...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2cd1cf29-f5a1-4b69-9535-42c6ee1645ff
```

> `2cd1cf29-f5a1-4b69-9535-42c6ee1645ff` is the password of the certificate, you can change it to any password you want.
